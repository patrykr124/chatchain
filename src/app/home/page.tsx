...
export default function HomeApp() {
  ...
  return (
    <section className="flex h-screen w-screen">
      <div className="w-[300px] gap-2 backdrop-blur-3xl shadow-2xl  h-screen overflow-hidden flex flex-col p-4 items-center">
      ...
      <div className="w-full bg-stone-100 flex flex-col justify-between p-2 ">
        <div className="bg-black/20">123</div>
        <div className="h-[80px] flex items-center">
          <form onSubmit={handleSendMessage} className="bg-black/10 rounded-md border-b-2 border-l-2  w-full flex items-center ">
